...
<%
    ...
    Entree avant = (Entree)request.getAttribute("avant");
    Entree apres = (Entree)request.getAttribute("apres");
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <table>
        ...
        <tbody>
                <tr>
                    ...
                    <td><%= avant.getDate_entree()%></td>
                    <td><%= avant.getId_magasin()%></td>
                    <td><%= apres.getQuantite()%></td>
                    <td><%= apres.getPrix_unitaire()%></td>
                    <td><%= avant.getQuantite()%></td>
                    <td><%= avant.getPrix_unitaire()%></td>
                </tr>
